        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-3 border border-gray-300 bg-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-80 text-gray-900 placeholder-gray-600"
            />
          </div>
        </div>
