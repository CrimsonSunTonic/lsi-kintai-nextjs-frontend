      ...
      <div className="max-w-4xl mx-auto text-center w-full mt-5">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-12 transform transition-all duration-500 hover:shadow-3xl relative overflow-hidden">
          ...
          <div className="relative">
            ...
            {/* User Greeting */}
            {user && (
              <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-xl p-6 inline-block mb-8 border border-white/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 max-w-2xl mx-auto">
              ...
              <button
                ...
                className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/30 hover:border-blue-400/50 hover:shadow-2xl hover:scale-105 transition-all duration-300 group cursor-pointer relative overflow-hidden"
              >
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl opacity-10 blur-sm group-hover:opacity-20 transition-opacity duration-300"></div>
                <div className="relative">
              ...
              <button
                ...
                className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/30 hover:border-green-400/50 hover:shadow-2xl hover:scale-105 transition-all duration-300 group cursor-pointer relative overflow-hidden"
              >
