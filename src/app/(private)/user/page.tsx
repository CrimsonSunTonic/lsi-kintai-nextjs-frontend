    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-12 transform transition-all duration-300">
          ...
          {/* Quick Stats - Commented out but kept for reference */}
          {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 text-center border border-blue-200">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-1">勤怠打刻</h3>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 text-center border border-purple-200">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-1">勤怠履歴</h3>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 text-center border border-orange-200">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-1">プロファイル</h3>
